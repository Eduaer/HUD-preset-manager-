...
def copiar_arquivo():
    ...
    arquivo_disableautostart = current_dir / "disbleautostart" / "create_shortcut_auto_start.py"
    
    try:
        # Verificar se o arquivo de origem existe
        if not arquivo_disableautostart.exists():
            print("[ERRO] Arquivo da pasta disbleautostart nao encontrado")
            return
        ...
        # 2. Copiar o arquivo da pasta disbleautostart para a pasta principal
        shutil.copy2(str(arquivo_disableautostart), str(arquivo_principal))
