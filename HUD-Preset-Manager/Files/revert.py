...
def marcar_cinhud_como_removida(diretorio_jogo):
...
def main():
    ...
    if tem_base:
        executar('myHud_to_game.py')
        executar('hudlayoutCL_ro game.py')
    else:
        executar('hudlayoutCL_ro game.py')
        executar('myHud_to_game.py')

    executar('revert_animations.py')
    marcar_cinhud_como_removida(diretorio_jogo)
    print('[OK] Cinhud revertida com sucesso.')
